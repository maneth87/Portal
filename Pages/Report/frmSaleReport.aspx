<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Content.master" AutoEventWireup="true" CodeFile="frmSaleReport.aspx.cs" Inherits="Pages_Report_frmSaleReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Main" runat="Server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#btnSearch').click(function () {
                ...
                var objDdlDateType = $('#Main_ddlDateOptions');
                ...
                if (objSession != null) {
                    if (Date.parse(new Date()) < Date.parse(objSession.Token.expire_at)) {
                        ...
                        var sendData = {
                            ...
                            DateOptions: objDdlDateType.find('option:selected').val(),
                            FromDate: objAppDateF.val(),
                            Todate: objAppDateT.val()
                        };

                        $.ajax({
                            url: objSession.APIUrl + 'Reports/SaleMicroReports',
                            method: 'POST',
                                ...
                                if (data.StatusCode == 200) {
                                    ...
                                    if (data.Detail != null) {
                                        $.each(data.Detail, function (index, val) {
                                            ...
                                            row += '<td class="col-xs-2">' + moment(val.EffectiveDate).format('DD-MMM-YYYY') + '</td>';
                                            row += '<td class="col-xs-2">' + val.ApplicationNumber + '</td>';
                                            row += '<td class="col-xs-2">' + val.PolicyNumber + '</td>';
            ...
            function ExportExcelAddMemberDetail() {
    ...
    <div class="row">
        ...
        <div id="dvApplicationInfo">
            ...
            <div class="col-md-12 div-title1 ">Select Criterials To Generate Report</div>
            <div class="col-md-3">
                <asp:Label runat="server" ID="Label4">Date Options</asp:Label>
                <asp:DropDownList ID="ddlDateOptions" runat="server" CssClass="form-control">
                    <asp:ListItem Text="Application Date" Value="APP_DATE"></asp:ListItem>
                    <asp:ListItem Text="Effective Date" Value="EFF_DATE"></asp:ListItem>

                </asp:DropDownList>
            </div>
            <div class="col-md-3">
                <asp:Label runat="server" ID="Label2">FROM</asp:Label><span class="star">*</span>
                ...
                <table id="tblResult" class="table ">
                    <thead>
                        <tr>
                            ...
                            <th class="col-xs-2">Eff. Date</th>
                            <th class="col-xs-2">App No.</th>
                            <th class="col-xs-2">Cert No.</th>
